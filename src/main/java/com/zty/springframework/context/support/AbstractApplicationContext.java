...
import com.zty.springframework.beans.factory.config.BeanFactoryPostProcessor;
...
import com.zty.springframework.context.ConfigurableApplicationContext;
import com.zty.springframework.context.event.ApplicationEventMulticaster;
import com.zty.springframework.context.event.ContextClosedEvent;
import com.zty.springframework.context.event.ContextRefreshedEvent;
import com.zty.springframework.context.event.SimpleApplicationEventMulticaster;
...
/**
 *
 * @description 抽象应用上下文 Abstract implementation of the {@link ApplicationContext}
