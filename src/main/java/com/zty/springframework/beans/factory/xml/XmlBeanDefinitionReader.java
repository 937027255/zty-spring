package com.zty.springframework.beans.factory.xml;
...
import com.zty.springframework.beans.factory.config.BeanReference;
import com.zty.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import com.zty.springframework.beans.factory.support.BeanDefinitionRegistry;
import com.zty.springframework.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        if (null != componentScan) {
            ...
            //将配置文件中的包扫描路径传入进行该路径下所有beanDefinition的加载
