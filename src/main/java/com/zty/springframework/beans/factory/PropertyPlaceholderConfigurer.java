...
import com.zty.springframework.util.StringValueResolver;
...
//这个类需要在xml中进行注册才能够生效
//在refresh中postProcessBeanFactory中会被调用
public class PropertyPlaceholderConfigurer implements BeanFactoryPostProcessor {
    ...
    private String location;//properties文件对应的位置
        ...
        try {
            ...
            for (String beanName : beanDefinitionNames) {
                ...
                for (PropertyValue propertyValue : propertyValues.getPropertyValues()) {
                    ...
                    //查看是否包含${key}这样的字段，如果包含就将将proerties中的内容添加到propertyValues中去
            ...
            beanFactory.addEmbeddedValueResolver(valueResolver);//将${...}解析器注册到了beanFactory中了
